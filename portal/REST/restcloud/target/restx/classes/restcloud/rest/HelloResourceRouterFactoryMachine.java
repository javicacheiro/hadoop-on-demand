...
import restcloud.rest.HelloResourceRouter;
...
private final Factory.Query<restcloud.rest.HelloResource> resource = Factory.Query.byClass(restcloud.rest.HelloResource.class).mandatory();
