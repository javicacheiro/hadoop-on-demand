...
import main.java.restcloud.AppModule;
...
public class AppModuleFactoryMachine extends DefaultFactoryMachine {
    ...
    public AppModuleFactoryMachine() {
        super(0, new MachineEngine[] {
            ...
            new StdMachineEngine<restx.config.ConfigSupplier>(Name.of(restx.config.ConfigSupplier.class, "appConfigSupplier"), BoundlessComponentBox.FACTORY) {
