function doKeys(){
	clearAllUsing();
	document.getElementById("keysTd").className="using";
...
// ***************** //
function doAddKeys(){
	document.getElementById("contentDiv").innerHTML='<div id="addKeyTableDiv"><table class="form_table">'
		+'<tr>'
...
// ***************** //
function doDelKeys(){
	document.getElementById("detailsDiv").innerHTML="Loading SSHKeys . . .";
...
function request_sshkeys(){
	...
	var request = $.ajax({
		...
		success: function(data){
			...
			document.getElementById("detailsDiv").innerHTML=print;
